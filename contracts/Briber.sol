...
contract Briber {
    ...
    mapping (uint => mapping (uint => mapping (uint => uint))) public hasBeenPaid;
    ...
    /** @dev Pays the amount of bribe to the jurors that voted for target ruling. 
     *  Sets hasBeenPaid to 1 when payment has been done
     */
